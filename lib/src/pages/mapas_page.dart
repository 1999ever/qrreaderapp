...
class MapasPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    //Esto es porque cuanodo voy a otra pagina y al volver a la pagina el circulas progres nunca para, entonces al usar esto estoy haciendo que se obtenga de nuevo los datos para ser mostrados.
    ...
    return StreamBuilder<List<ScanModel>>(
      ...
      builder: (BuildContext context, AsyncSnapshot<List<ScanModel>> snapshot) {
        ...
        //pero si hay informacion en la bd, osea hay registros del escaneo muestro dichos resultados usando el ListView.builder para construir esos resultados en la pagina.
        return ListView.builder(
          ...
          itemBuilder: (context, index) => Dismissible(//crea un widget que puede ser despedido(quitar)
            ...
            child: ListTile(
              ...
              onTap: () {
                //abrimos el resultado del escaneo ya sea en un navegador o la pagina de mapa
